...
export const features: WizardFeature[] = [
  {
    id: 'info-collection',
    icon: '📋',
    title: 'Collecte d\'informations Client',
    description: 'Recueillir et mettre à jour les coordonnées et préférences clients',
    defaultSelected: true,
  },
  {
    id: 'human-escalation',
    icon: '🙋',
    title: 'Escalade vers Agent Humain',
    description: 'Transfert intelligent vers un support humain si nécessaire',
    defaultSelected: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Identifier l\'intention et transférer vers le bon sous-agent',
  },
  {
    id: 'product-recommendations',
    icon: '💡',
    title: 'Recommandations de Produits',
    description: 'Suggérer des produits pertinents basés sur le contexte',
  },
  {
    id: 'appointments',
    icon: '📅',
    title: 'Prise de Rendez-vous',
    description: 'Réserver, modifier et annuler des rendez-vous automatiquement',
  },
  {
    id: 'order-tracking',
    icon: '📦',
